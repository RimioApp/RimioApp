          ...
          children: [
                        ...
                        Container(
                            ...
                            child: IconButton(
                                onPressed: () async {
                                  ...
                                  DynamicLinkProvider().createLink(getCurrentProduct.productId).then((value) {
                                    Share.share(value);
                                  });
            ...
            Row(
              children: [
                Padding(
                  ...
                  child: Column(
                    children: [
                      FavButton(productId: getCurrentProduct.productId, size: 40,),
                ...
                : Expanded(
                  child: Padding(
                    ...
                    child: SizedBox(
                      height: 60,
                      child: orderProvider.getUserOrders.containsKey(productId)
                          ? const SizedBox.shrink()
                          : ElevatedButton(
                        style: ElevatedButton.styleFrom(
                            elevation: 3,
                        ...
                        child: const Text('Comprar', style: TextStyle(fontSize: 25),)),
                        onPressed: () async {
                                ...
                                if (_preguntaController.text.isEmpty) {
                                  ...
                                  try {
                                    await preguntaProvider
                                      ...
                                      productId: productId,
                                      context: context,
                                      productTitle: getCurrentProduct
                                          .productTitle,
                                      displayName: getCurrentProduct
                                          .displayName,
                                    ...
                                    sendEmail(
                                        ...
                                        email: getCurrentProduct.userEmail,
                                        subject: '¡${user
                                            .displayName} te ha preguntado por ${getCurrentProduct
                                            .productTitle}!',
                                    ...
                                    sendEmail(
                                      ...
                                      message: 'Tu pregunta ha sido enviada con éxito a ${getCurrentProduct
                                          .displayName} de ${getCurrentProduct
                                          .productTitle}'
                                          '\n\nTu pregunta: ${_preguntaController
                                          .text}',);
            ...
            Visibility(
              ...
              child: StreamBuilder<QuerySnapshot>(
                  ...
                  doc('${getCurrentProduct.productTitle} ID:${getCurrentProduct.productId}').collection('preguntas').orderBy('createAt', descending: true).snapshots(),
                          ...
                          return Padding(
                            ...
                            child: Stack(
                              children:[
                                          ...
                                          children: [
                                            Row(
                                              children: [
                                                CircleAvatar(
                                                  radius: 25,
                                                  backgroundImage: NetworkImage(document['imagen']),
                                                ),
                                                const SizedBox(width: 15,),
                                                Text(document['emisor']),
                                              ],
                                            ),
                                            Padding(
                                              padding: const EdgeInsets.all(8.0),
                                              child: Row(
                                                children: [
                                                  SizedBox(
                                                      width: 300,
                                                      child: Text(document['pregunta'], style: const TextStyle(color: Colors.black87,),)),
                                                ],
                                              ),
                                            ),
                                          ],
                                ...
                                if (getCurrentProduct.userId == user!.uid)...[
                                  Positioned(
                                  right: 15,
                                  top: 0,
                                  child:
                                  FloatingActionButton(
                                                  ...
                                                  onPressed: () async {
                                                    ...
                                                    if (_respuestaController.text.isEmpty) {
                                                      ...
                                                      sendEmail(
                                                          ...
                                                          subject: '¡${getCurrentProduct
                                                              .displayName} te ha respondido por ${getCurrentProduct
                                                              .productTitle}!',
                                                          message: _respuestaController
                                                              .text);
                                                      ...
                                                      sendEmail(
                                                        ...
                                                        message: 'Tu respuesta ha sido enviada con éxito a ${document['emisor']} de ${getCurrentProduct
                                                            .productTitle}'
                                                            '\n\nTu respuesta: ${_respuestaController
                                                            .text}',);
                                                      ...
                                                      try {
                                                        await preguntaProvider
                                                          ...
                                                          respuesta: _respuestaController
                                                              .text,
                                                          productId: productId,
                                                          context: context,
                                                          productTitle: getCurrentProduct
                                    ...
                                    child: const Icon(Icons.send_rounded, size: 25, color: Colors.deepPurple,),)
                                ),
                            ] else ... [
                              const SizedBox.shrink()
                                ]
